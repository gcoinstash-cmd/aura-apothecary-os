...
import { Compass, Sparkles, Sliders, Play, Trash2, Plus, ArrowRight, Eye, RefreshCw, Lock, X } from 'lucide-react';
import ParfumeurAdminDashboard from './components/ParfumeurAdminDashboard';
...
export default function App() {
  ...
  const handleAdminUnlock = (e: React.FormEvent) => {
    e.preventDefault();
    if (adminPassInput.trim() === 'apothecary2026') {
      setIsAdminMode(true);
      setIsAdminPassModalOpen(false);
      setAdminPassInput('');
    } else {
      alert('Invalid passcode. Use demo key: apothecary2026');
    }
  };
  ...
  if (isAdminMode) {
    return <ParfumeurAdminDashboard onExit={() => setIsAdminMode(false)} />;
  }
    ...
    <div className="min-h-screen bg-[#FAF9F6] text-[#29241E] font-sans selection:bg-[#A2947F]/20 select-none pb-24">
      ...
      <header className="sticky top-0 bg-[#FAF9F6]/85 backdrop-blur-md z-40 border-b border-stone-200/40 py-5 px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-6" aria-label="Main Navigation">
          <button
            ...
            className={`font-sans text-xs font-semibold uppercase tracking-[0.16em] transition-colors focus:outline-none cursor-pointer ${
          ...
          <button
            ...
            className={`flex items-center gap-1.5 font-sans text-xs font-semibold uppercase tracking-[0.16em] transition-colors focus:outline-none cursor-pointer ${
              isLabMode ? 'text-stone-900 font-medium border-b border-stone-850 pb-0.5' : 'text-stone-400 hover:text-stone-700'
            }`}
          >
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 font-mono text-xs font-semibold tracking-wider uppercase tracking-widest text-amber-800 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-600/30 px-3 py-1.5 transition-all cursor-pointer"
          >
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&q=80&w=1200">
      ...
      {isAdminPassModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#121215] border border-[#27272A] w-full max-w-md p-8 relative shadow-2xl">
            <button
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-serif text-white tracking-wide">AURA ATELIER OS</h3>
                <p className="text-xs font-mono text-zinc-400">Restricted Master Parfumeur Portal</p>
              </div>
            </div>

            {/* 1-Click Cheat Code Autofill Pill */}
            <div className="mb-6 p-4 bg-[#18181D] border border-[#2E2E35]">
              ...
              <button
                type="button"
                onClick={() => setAdminPassInput('apothecary2026')}
