      ...
      <header className="sticky top-0 bg-[#FAF9F6]/85 backdrop-blur-md z-40 border-b border-stone-200/40 py-5 px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-6" aria-label="Main Navigation">
          <button
            ...
            className={`font-sans text-[11px] uppercase tracking-[0.16em] transition-colors focus:outline-none cursor-pointer ${
          ...
          <button
            ...
            className={`flex items-center gap-1.5 font-sans text-[11px] uppercase tracking-[0.16em] transition-colors focus:outline-none cursor-pointer ${
              isLabMode ? 'text-stone-900 font-medium border-b border-stone-850 pb-0.5' : 'text-stone-400 hover:text-stone-700'
            }`}
          >
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-amber-800 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-600/30 px-3 py-1.5 transition-all cursor-pointer"
          >
